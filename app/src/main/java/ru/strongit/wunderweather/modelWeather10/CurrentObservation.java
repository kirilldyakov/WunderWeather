...
public class CurrentObservation {
    ...
    private Long mWindGustKph;
    @SerializedName("wind_gust_mph")
    private Long mWindGustMph;
    @SerializedName("wind_kph")
    private Long mWindKph;
    ...
    public Long getWindKph() {
        return mWindKph;
    }

    public void setWindKph(Long windKph) {
        mWindKph = windKph;
    }
